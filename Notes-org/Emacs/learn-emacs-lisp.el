...
;; `setq' 设置当前缓冲区 (Buffer) 中的变量值, `setq-default' 设置全局的变量值.
...
;; My addings
;; This function introduces how to bind a short key by using `global-set-key'
(defun func ()
  (message "Hello, %s" name))

(global-set-key (kbd "<f1>") 'func)

;; Call function directly by using `(interactive)'
(defun func()
  (interactive)
  (message "Hello, %s" name))
